...
struct BuildArtifactsView: View {
    ...
    private var cleanConfirmationMessage: String {
        if recentlyModifiedCount > 0 {
            return "Warning: \(recentlyModifiedCount) selected project(s) were modified recently "
                + "and may be in active development.\n\nThis will move build artifacts to Trash "
                + "and remove selected stale Git worktrees or branches."
        }
